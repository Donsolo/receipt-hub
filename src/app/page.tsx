  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] flex flex-col font-sans text-[var(--text)]">
        ...
        <div className="text-center z-10 w-full max-w-4xl relative flex flex-col items-center">
          <div className="flex flex-col items-center justify-center mb-6 w-full">
            <Image
              ...
              width={600}
              height={150}
              className="w-[280px] sm:w-[400px] md:w-[550px] h-auto object-contain drop-shadow-md mx-auto"
              priority
            />
          </div>
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 justify-center items-center w-full">
            ...
            <Link
              href="/login"
              className="inline-flex items-center justify-center px-10 py-3.5 h-[52px] rounded-lg bg-white/10 backdrop-blur-sm border-2 border-white/20 text-white hover:border-white/40 hover:bg-white/20 font-semibold text-lg transition-all w-full sm:w-auto"
            >
              Sign In
            </Link>
          </div>

          {/* Global Trust Strip - Moved INSIDE Hero */}
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 text-[13px] font-medium text-white uppercase tracking-widest pt-16 pb-4 mt-2 w-full max-w-3xl relative z-10 drop-shadow-sm">
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        {/* Layer 1: Base Background & Layer 2: Radial Glow */}
        ...
        <div className="relative w-full max-w-5xl mx-auto mt-8 mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 relative z-10 text-left">
            ...
            <div className="relative bg-[#0b1121]/80 backdrop-blur-md border border-slate-700/80 rounded-2xl p-8 transition-all duration-300 hover:border-indigo-500/50 hover:shadow-[0_8px_30px_rgba(79,70,229,0.12)] hover:-translate-y-1 flex items-start gap-5 group">
