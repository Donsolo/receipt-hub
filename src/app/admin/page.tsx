                        ...
                        <div className="p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div className="bg-[var(--bg)]/50 border border-[var(--border)] rounded-md p-6 flex flex-col items-center justify-center text-center">
                                    ...
                                    <h4 className="text-[var(--text)] font-medium mb-1">Global Heros</h4>
                                    <p className="text-sm text-[var(--muted)] mb-5 max-w-xs">Upload images and configure the design for top-level page banners.</p>
                                    <Link href="/admin/hero-manager" className="bg-cyan-600/10 hover:bg-cyan-600/20 text-cyan-400 border border-cyan-500/20 text-sm font-medium px-6 py-2 rounded-md transition-colors w-full max-w-[200px]">
                                        Hero Manager
                                    </Link>
                                </div>
                                ...
                                <div className="bg-[var(--bg)]/50 border border-[var(--border)] rounded-md p-6 flex flex-col items-center justify-center text-center">
                                    ...
                                    <h4 className="text-[var(--text)] font-medium mb-1">App Releases</h4>
                                    <p className="text-sm text-[var(--muted)] mb-5 max-w-xs">Upload and distribute Beta APK files directly to testers.</p>
                                    <Link href="/admin/app-releases" className="bg-orange-600/10 hover:bg-orange-600/20 text-orange-400 border border-orange-500/20 text-sm font-medium px-6 py-2 rounded-md transition-colors w-full max-w-[200px]">
                                        App Releases
                                    </Link>
                                </div>
                            </div>
