...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[var(--bg)] px-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md bg-gradient-to-br from-[#111827] to-[#0F172A] border border-[var(--border)] rounded-2xl p-8 shadow-xl shadow-black/20 relative z-10">
                <div className="text-center mb-8">
                    <h2 className="text-2xl font-semibold text-[var(--text)]">Welcome Back</h2>
                    <p className="text-sm text-[var(--muted)] mt-2">Sign in to access your receipts.</p>
                </div>
                ...
                <form className="space-y-6" onSubmit={handleLogin}>
                    ...
                    <button
                        type="submit"
                        className="w-full mt-6 h-12 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-[var(--text)] font-medium transition-colors duration-200 shadow-lg shadow-indigo-600/20"
                    >
                        Sign in
                    </button>
                </form>
