        ...
        <div className="space-y-6">
            <div className="md:flex md:items-center md:justify-between">
                ...
                <div className="mt-4 flex md:mt-0 md:ml-4 space-x-3">
                    <Link
                        href="/uploads"
                        className="inline-flex items-center px-4 py-2 border border-gray-600 rounded-lg shadow-sm text-sm font-medium text-gray-200 bg-transparent hover:bg-white/5 hover:text-white transition-all duration-200"
                    >
                        Upload Receipt
                    </Link>
                    <Link
            ...
            <div key={activeView} className="animate-in fade-in slide-in-from-bottom-2 duration-500 fill-mode-both">
                ...
                {activeView === 'bundles' && (
                    <div className="bg-[#111827] rounded-2xl shadow-sm border border-[#2D3748] overflow-hidden rounded-t-none border-t-0 p-2 sm:p-4 min-h-[500px]">
                        <BundlesClient />
                    </div>
                )}
            </div>
