                ...
                <div className="max-w-5xl mx-auto space-y-6">
                    ...
                    <div className="mb-5">
                        <PageHeaderCard
                            ...
                            description="Here’s your receipt workspace command center."
                        >
                            <div className="flex items-center gap-3 mt-1">
                                {user?.isEarlyAccess && !isPro && (
                                    <span className="inline-flex w-fit items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-900/40 text-indigo-300 border border-indigo-800/50 shadow-sm">
                                        Core (Early Access Founder)
                                    </span>
                                )}
                                {isPro && (
                                    <span className="inline-flex w-fit items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-500/10 text-yellow-500 border border-yellow-500/30 shadow-sm shadow-yellow-500/10">
                                        PRO
                                    </span>
                                )}
                                {!isPro && (
