...
export default function ChatClient({ conversationId }: { conversationId: string }) {
    ...
    return (
        <div className="fixed top-[calc(61px+env(safe-area-inset-top))] bottom-0 left-0 right-0 z-10 flex flex-col bg-[#F7F8FA] dark:bg-[var(--bg)] font-sans overflow-hidden">
            {/* STICKY HEADER */}
