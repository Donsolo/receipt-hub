    ...
    return (
        <div className="min-h-screen bg-[var(--bg)] p-4 sm:p-8">
            <div className="max-w-4xl mx-auto">
                <div className="mb-8">
                    <h1 className="text-[28px] font-bold text-[var(--text)] tracking-tight">Messages</h1>
                    <p className="text-[var(--muted)] text-[15px] mt-1">Manage your direct conversations with connections.</p>
                </div>
