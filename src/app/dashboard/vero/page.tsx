                        ...
                        <div className="flex overflow-x-auto gap-6 pb-6 pt-2 snap-x snap-mandatory scroll-pl-4 sm:scroll-pl-6 lg:scroll-pl-8 custom-scrollbar">
                            ...
                            {isPro && (
                                <div onClick={() => router.push('/dashboard/vero/lens')} className="w-[280px] sm:w-[320px] h-[360px] shrink-0 snap-start bg-[var(--card)] border border-[var(--border)] rounded-2xl flex flex-col shadow-sm hover:shadow-md transition-all hover:-translate-y-1 focus-within:ring-2 focus-within:ring-indigo-500 relative overflow-hidden group cursor-pointer">
                                    ...
                                    <div className="p-4 bg-[var(--card)] border-t border-[var(--border)] shrink-0 z-10">
                                        <button 
                                            onClick={(e) => { e.stopPropagation(); router.push('/dashboard/vero/lens'); }}
                                            className="w-full bg-indigo-600/10 hover:bg-indigo-600/20 text-indigo-600 dark:text-indigo-400 border border-indigo-500/20 text-sm font-medium px-4 py-2.5 rounded-xl transition-colors outline-none"
                                        >
                                            Open Tool
                                        </button>
                                    </div>
