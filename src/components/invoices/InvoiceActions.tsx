...
export default function InvoiceActions({ invoice }: { invoice: { id: string; status: string; isConverted: boolean } }) {
    ...
    return (
        <>
            <div className="flex items-center justify-center gap-2">
                ...
                {/* View (No Op for now) */}
                <button className="text-[var(--muted)] hover:text-blue-500 transition-colors p-1 hidden sm:block" title="View">
