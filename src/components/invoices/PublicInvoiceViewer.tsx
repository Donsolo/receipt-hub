                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                {invoice.invoiceNumber && (
                                    <span className="inline-flex items-center px-3 py-1 bg-white/50 dark:bg-black/20 rounded-full text-sm font-mono font-bold text-gray-500 dark:text-[var(--muted)] ring-1 ring-black/5 dark:ring-white/10">
                                        #{invoice.invoiceNumber}
                                    </span>
                                )}
                            </div>
                        ...
                        <div className="w-full sm:w-80 bg-gray-50 dark:bg-black/20 rounded-2xl p-6 ring-1 ring-black/5 dark:ring-white/5 print:bg-transparent print:ring-0 print:border-t print:border-gray-200 print:rounded-none">
                            ...
                            <div className="flex justify-between items-center">
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-[10px] sm:text-xs font-bold text-gray-400 dark:text-[var(--muted)]/80 uppercase tracking-widest mt-0.5">Pay Total</span>
                                </div>
